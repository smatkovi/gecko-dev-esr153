...
class SwapChain final {
 ...
 public:
  ...
  // Acquire() calls ago the same surface was last used, or 0 when it has
  // never been used before (then its contents are undefined).
  size_t LastAcquiredAge() const { return mLastAcquiredAge; }
